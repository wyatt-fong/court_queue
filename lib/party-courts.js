...
export async function fetchPartyCourtsForUser(user, gym) {
    ...
    return {
        ...
        const queuedParties = parties
            ...
            .slice(0, 5)
            .map((party) => mapParty(party, user, userMembership, userIsAdmin, court.queue_disabled));
        ...
        const userParty = userPartyRow
            ? mapParty(userPartyRow, user, userMembership, userIsAdmin, court.queue_disabled)
            : null;
