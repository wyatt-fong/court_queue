...
const DEMO_ACCOUNTS = [
  { username: "p1", password: "p1", displayName: "Player 1", isAdmin: true },
  { username: "p2", password: "p2", displayName: "Player 2", isAdmin: false },
  { username: "p3", password: "p3", displayName: "Player 3", isAdmin: false },
  { username: "p4", password: "p4", displayName: "Player 4", isAdmin: false },
];
...
export async function signInDemoUser(username, password) {
  const normalizedUsername = username?.trim().toLowerCase();
  const account = DEMO_ACCOUNTS.find(
    (demoAccount) =>
      demoAccount.username === normalizedUsername && demoAccount.password === password,
  );
